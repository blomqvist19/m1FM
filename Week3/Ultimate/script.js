...
let colorShift = ["#275059", "#267373", "#2A8C82", "#D98D30", "#BF6E3F", "#BF5A36"];
let count = 0;
...
function processPoses(poses) {
  ...
  function change() {
    document.body.style.backgroundColor = colorShift[count];
    count+=1
    if(count >= 3 + poses.length) {
        count = 0;
   }
  }

  // Call for color change depending on
change();
