...
function renderFrame() {
  ...
  if (p) {
    ...
    eventData.rotation = (eventData.rotation * -1);
    //eventData.rotation = Math.abs(eventData.rotation * 10);
...
function processTrack(p) {
  ...
  eventData.vert = vDistance / canvasEl.width;
