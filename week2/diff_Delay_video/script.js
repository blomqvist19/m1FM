...
cameraEl.addEventListener('play', () => {
  ...
  offscreenCanvasEl.width = window.innerWidth;//cameraEl.videoWidth;
  offscreenCanvasEl.height = window.innerHeight;//cameraEl.videoHeight;
  canvasEl.width = window.innerWidth;//cameraEl.videoWidth;
  canvasEl.height = window.innerHeight;//cameraEl.videoHeight;
...
function renderFrame() {
  ...
  let timer = setTimeout(timerFunc, 5000);
...
//let timerFunc = setInterval(comparePixel, 1000);
